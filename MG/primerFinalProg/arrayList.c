...
{
    int returnAux = -1;
    if((this != NULL && pElement != NULL && index >= 0 && index >= this->reservedSize) || !resizeUp(this))
    {
        expand(this, index);
...
ArrayList* al_subList(ArrayList* this,int from,int to)
{
    void* returnAux = NULL;
    int i;
    if(this != NULL && from >= 0 && from <= to && to >= from && to <= this->size)
    {
        returnAux= al_newArrayList();
        for(i=from; i<=to; i++)
        {
...
int al_containsAll(ArrayList* this,ArrayList* this2)
{
    int returnAux = -1;
    int i;
    if(this != NULL && this2 != NULL && !al_contains(this, this2))
    {
        for(i=0; i<=this->size; i++)
        {
            ...
            for(i=0; i<this->size-1; i++)
               {
                    ...
                    {
                        auxiliar->pElements = this->pElements[i];
                        this->pElements[i] = this->pElements[i+1];
                        this->pElements[i+1] = auxiliar->pElements;
                        flag=1;
                    }
               }
            }while(flag!=0);
